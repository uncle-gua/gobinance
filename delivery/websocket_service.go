...
func WsIndexPriceServe(symbol string, handler WsIndexPriceHandler, errHandler ErrHandler, logger *Logger) (done chan struct{}, err error) {
...
func WsPairMarkPriceServe(handler WsPairMarkPriceHandler, errHandler ErrHandler, logger *Logger) (done chan struct{}, err error) {
...
func WsContinuousKlineServe(pair string, contractType string, interval string, handler WsContinuousKlineHandler, errHandler ErrHandler, logger *Logger) (done chan struct{}, err error) {
...
func WsIndexPriceKlineServe(pair string, interval string, handler WsIndexPriceKlineHandler, errHandler ErrHandler, logger *Logger) (done chan struct{}, err error) {
...
func WsMarkPriceKlineServe(symbol string, interval string, handler WsMarkPriceKlineHandler, errHandler ErrHandler, logger *Logger) (done chan struct{}, err error) {
...
func WsPartialDepthServeWithRate(symbol string, levels int, rate *time.Duration, handler WsDepthHandler, errHandler ErrHandler, logger *Logger) (done chan struct{}, err error) {
