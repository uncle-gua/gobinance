...
type markPriceKlineServiceTestSuite struct {
	baseTestSuite
}

func TestMarkPriceKlineService(t *testing.T) {
	suite.Run(t, new(markPriceKlineServiceTestSuite))
}

func (s *markPriceKlineServiceTestSuite) TestKlines() {
	data := []byte(`[
        [
            1499040000000,
            "0.01634790",
